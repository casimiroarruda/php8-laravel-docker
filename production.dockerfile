...
RUN apk --update add php8-bcmath php8-bz2 php8-calendar php8-ctype php8-exif php8-fpm php8-gd php8-gettext php8-gmp php8-mysqlnd \
    ...
    php8-pecl-igbinary php8-pecl-redis php8-pecl-mongodb php8-pecl-memcache php8-pecl-memcached
RUN ln -s /usr/local/etc/php/php.ini-production /usr/local/etc/php/php.ini
COPY .docker-resources/php/extra.ini /etc/php8/conf.d/99_extra.ini
